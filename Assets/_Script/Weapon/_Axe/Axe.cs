...
public partial class Axe : BaseWeapon
{
    ...
    {
        inputHandler.PlayerInput.Attack.performed += context => MeleeAttackPerform();
    }
    
    void MeleeAttackPerform()
    {
    ...
    {
        weaponCombo.SetStateMachine(authenticatedOwner.GetModifiableAnimator().characterAnimator);
